...
class ExampleProblemDefaultScoring : public ExampleProblem,
                                     public testing::WithParamInterface<ScoringParam> {};
TEST_P(ExampleProblemDefaultScoring, Mode) {
  ...
  sub.reporter.ReportScoringResult = [&](const Submission& sub, const SubmissionResult& res, int subtask,
                                         int stage) {
...
char buf[256];
int main(){ write(1, buf, read(0, buf, 256)); })",
...
INSTANTIATE_TEST_SUITE_P(
    OneSubmission, ExampleProblemDefaultScoring,
    testing::Values(
        (ScoringParam){{"strict"}, {{AC, WA, WA, WA, WA, WA, WA, WA, WA, WA}}},
        (ScoringParam){{"line"}, {{AC, AC, WA, WA, WA, WA, WA, WA, WA, WA}}},
        (ScoringParam){{}, {{AC, AC, WA, WA, WA, WA, WA, WA, WA, WA}}},
        (ScoringParam){{"white-diff"}, {{AC, AC, AC, AC, WA, WA, WA, WA, WA, WA}}},
        (ScoringParam){{"float-diff", "absolute-relative", "1e-9"},
                       {{AC, AC, AC, AC, WA, WA, WA, WA, WA, WA}}},
        (ScoringParam){{"float-diff", "absolute", "1e-6"}, {{AC, AC, AC, AC, AC, AC, WA, WA, WA, WA}}},
        (ScoringParam){{"float-diff", "absolute"}, {{AC, AC, AC, AC, AC, AC, WA, WA, WA, WA}}},
        (ScoringParam){{"float-diff", "relative"}, {{AC, AC, AC, AC, AC, AC, WA, AC, WA, WA}}},
        (ScoringParam){{"float-diff", "absolute-relative"}, {{AC, AC, AC, AC, AC, AC, WA, AC, AC, WA}}},
        (ScoringParam){{"float-diff"}, {{AC, AC, AC, AC, AC, AC, WA, AC, AC, WA}}},
        (ScoringParam){{"float-diff", "relative", "1e-4"}, {{AC, AC, AC, AC, AC, AC, AC, AC, AC, WA}}}),
    ParamName);
